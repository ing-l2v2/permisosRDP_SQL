/*
    EXEC sp_infra_ini_asignar_permiso_temporal 'kcuenca', 'JOB', 117, 48, '2026-03-04 23:00', 16849, '00120';
    EXEC sp_infra_ini_asignar_permiso_temporal 'mvasquez', 'RWSP', 118, 48, '2026-03-03 20:20', NULL, NULL;
    EXEC sp_infra_ini_revocar_permiso_unitario 'mvasquez', 'ALL', 118;
    EXEC sp_infra_ini_revocar_permiso_unitario 'mvasquez', 'RWSP', 118;
